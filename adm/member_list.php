...
<div class="btn_add01 btn_add">
    <a href="./member_form.php" id="member_add" class="btn_type03">회원추가</a>
</div>
<?php } ?>
...
<div class="btn_list01 btn_list">
    <input type="submit" name="act_button" value="선택수정" onclick="document.pressed=this.value" class="btn_type01">
    <input type="submit" name="act_button" value="선택삭제" onclick="document.pressed=this.value" class="btn_type02">
</div>
