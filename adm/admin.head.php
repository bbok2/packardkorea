...
<header id="hd">
    <div id="hd_wrap">
        ...
        <div class="hd_top">
            <div id="logo"><a href="<?php echo G5_ADMIN_URL ?>"><img src="/img/common/logo_w.png" alt="<?php echo $config['cf_title'] ?> 관리자"></a></div>

            <ul id="tnb">
                <li><a href="https://analytics.google.com" target="_blank">구글접속통계</a></li>
