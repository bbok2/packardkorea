...
<section>
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <td><a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=<?php echo $row['bo_table'] ?>&amp;wr_id=<?php echo $row2['wr_id'] ?><?php echo $comment_link ?>" target="_blank"><?php echo $comment ?><?php echo conv_subject($row2['wr_subject'], 100) ?></a></td>
