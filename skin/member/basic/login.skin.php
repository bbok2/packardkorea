            ...
            <form name="flogin" action="<?php echo $login_action_url ?>" onsubmit="return flogin_submit(this);" method="post">
                ...
                <div class="form-group agreeCheck">
                    <div class="rememberPw">
                        ...
                        <label for="login_auto_login">로그인 기억하기</label>
                    </div>
                ...
                <aside id="login_info">                    
                    ...
                    <div class="inner ac">
                        아이디/패스워드를 잊으셨습니까? 
                        <a href="<?php echo G5_BBS_URL ?>/password_lost.php" target="_blank" id="login_password_lost" class="f_red01 f_bold">아이디 비밀번호 찾기</a><!-- <a href="./register.php" class="">회원 가입</a> -->
                    </div>
                </aside>
